# Generated by Django 4.0.5 on 2022-06-20 21:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.BooleanField(default=True, verbose_name='Ativo')),
                ('categoria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='imobiliaria.categoria')),
                ('tipoImovel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='imobiliaria.tipoimovel')),
            ],
            options={
